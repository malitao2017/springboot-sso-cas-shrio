...
//    public static final String casServerUrlPrefix = "https://127.0.0.1:8443/cas";//不配置host
    // Cas登录页面地址
    public static final String casLoginUrl = casServerUrlPrefix + "/login";
    // Cas登出页面地址
    public static final String casLogoutUrl = casServerUrlPrefix + "/logout";
    // 当前工程对外提供的服务地址
//    public static final String shiroServerUrlPrefix = "http://localhost:8081";//本机nexus占用
//    public static final String shiroServerUrlPrefix = "http://localhost:8080";//中间件cas-server占用
    public static final String shiroServerUrlPrefix = "http://localhost:8082";//本机nexus占用
    // casFilter UrlPattern
    public static final String casFilterUrlPattern = "/cas";
    // 登录地址 ：https://sso.maple.com:8443/cas/login?service=http://localhost:8082/cas
    ...
    // 登录地址 ：https://sso.maple.com:8443/cas/logout?service=http://localhost:8082
...
//        userShiroCasRealm.setCredentialsMatcher(hashedCredentialsMatcher());
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager, CasFilter casFilter) {
        ...
        //第一节：只用shrio，注释掉CAS样式，换成shiro的样式
        // 登录地址 ：https://sso.maple.com:8443/cas/login?service=http://localhost:8082/cas
