...
//    public static final String shiroServerUrlPrefix = "http://localhost:8081";
    public static final String shiroServerUrlPrefix = "http://localhost:8080";//本机nexus占用
...
//        第一节：只用shiro的名称，为了对比，还是带上cas
//        UserShiroRealm userShiroRealm = new UserShiroRealm();
        UserShiroRealm userShiroCasRealm = new UserShiroRealm();
        //第一节只用shiro作权限验证，注释掉
...
//        shiroFilterFactoryBean.setLoginUrl(loginUrl);
        ...
        //第一节：只用shrio，放开注释，成功跳转到 /user
        shiroFilterFactoryBean.setSuccessUrl(loginSuccessUrl);
        //第一节：只用shrio，是403
//        shiroFilterFactoryBean.setUnauthorizedUrl(unauthorizedUrl);
        shiroFilterFactoryBean.setUnauthorizedUrl("/403");

        //第一节：只用shrio，没有这部分过滤器
...
//        filterChainDefinitionMap.put(casFilterUrlPattern, "casFilter");
        ...
        //第一节：只用shiro，放开注释，index 没有拦截，直接登录
